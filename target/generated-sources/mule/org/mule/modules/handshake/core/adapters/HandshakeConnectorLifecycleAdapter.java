...
/**
 * A <code>HandshakeConnectorLifecycleAdapter</code> is a wrapper around {@link HandshakeConnector } that adds lifecycle methods to the pojo.
 * 
 */
@Generated(value = "Mule DevKit Version 3.5.3", date = "2015-12-18T03:29:05-03:00", comments = "Build UNNAMED.2049.ec39f2b")
public class HandshakeConnectorLifecycleAdapter
    extends HandshakeConnectorMetadataAdapater
    implements Disposable, Initialisable, Startable, Stoppable
{
    ...
    {
        Logger log = LoggerFactory.getLogger(HandshakeConnectorLifecycleAdapter.class);
